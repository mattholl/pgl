...
var pglUtils = require('./pgl-utils');
...
scene.prototype.addFloor = function(args) {
    ...
    if(args) {
        gridParams = args.gridSettings;
    }

    var gridSettings = pglUtils.merge(gridParams, gridDefaults);

    var gridGeom = new geom.planeGrid(gridSettings);
