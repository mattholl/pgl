...
scene.prototype.addFloor = function(params) {
    // console.log(args);
    // add overidable defaults to the params


    var grid = new geom.planeGrid(settings);

    var defaults = {
        geometry : new geom.planeGrid(),
        scene : this,
        name : 'floor',
    ...
    var settings = pglUtils.merge(params, defaults);
